...
class RandomLoadText:
    ...
    def __init__(self,
        ...
        self.original_texts = [item[0] for item in text_list]
    ...
    def __call__(self, results: dict) -> dict:
        ...
        corresponding_matrix = torch.arange(1, len(self.original_texts) + 1)
        ...
        text_to_index = {text: index for index, text in enumerate(self.original_texts)}
        new_indices = [text_to_index[text] for text in texts]
        
        corres_matrix = corresponding_matrix[new_indices]
        results['texts'] = texts

        results['corres_matrix'] = corres_matrix
